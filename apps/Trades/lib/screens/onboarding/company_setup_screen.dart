...
/// Collects company name and optional business details
...
class _CompanySetupScreenState extends ConsumerState<CompanySetupScreen> {
  ...
  String get _tierLabel {
    switch (widget.selectedTier) {
      case CompanyTier.solo:
        return 'Solo Tradesman';
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Icon(_tierIcon, size: 18, color: colors.textPrimary),
                      ...
                      Text(
                        'This appears on invoices and job assignments.',
                        style: TextStyle(
