...
const SYMBOL_LABELS: Record<SiteSymbolType, string> = {
  ...
  handicapParking: 'ADA',
  handicapParkingVan: 'Van',
  adaCurbRamp: 'Ramp',
  loadingDockSymbol: 'Dock',
  dumpsterEnclosure: 'Dump',
  bollard: 'Boll',
  guardBooth: 'Guard',
  securityGateArm: 'Gate',
  parkingLotLight: 'PLt',
  speedBump: 'Bump',
  bikeRack: 'Bike',
  busStopShelter: 'Bus',
  ...
  monumentSign: 'Mon',
  pylonSign: 'Pylon',
  shoppingCartCorral: 'Cart',
  outdoorSeatingSymbol: 'Seat',
  fuelDispenser: 'Fuel',
  fuelCanopy: 'Canpy',
  carWashBaySymbol: 'Wash',
  storageUnitRow: 'Stor',
  playgroundEquipment: 'Play',
  sportsCourt: 'Court',
  swimmingPoolSymbol: 'Pool',
  transformerPad: 'Xfmr',
  generatorPad: 'Gen',
  roofDrainSymbol: 'RDrn',
  roofHatchSymbol: 'RHtch',
  rtuSymbol: 'RTU',
};
