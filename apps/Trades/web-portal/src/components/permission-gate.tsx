...
export const PERMISSIONS = {
  ...
  // Bids & Estimates
  BIDS_VIEW_OWN: 'bids.view.own',
  BIDS_VIEW_ALL: 'bids.view.all',
  BIDS_CREATE: 'bids.create',
  BIDS_EDIT_OWN: 'bids.edit.own',
  BIDS_EDIT_ALL: 'bids.edit.all',
  BIDS_SEND: 'bids.send',
  BIDS_APPROVE: 'bids.approve',
...
// Default permissions by role. Custom roles override these via custom_roles table.
export const ROLE_PERMISSIONS: Record<string, Permission[]> = {
  owner: Object.values(PERMISSIONS),
  super_admin: Object.values(PERMISSIONS),
  admin: Object.values(PERMISSIONS).filter((p) => p !== PERMISSIONS.BILLING_MANAGE),
  office_manager: [
    PERMISSIONS.JOBS_VIEW_ALL, PERMISSIONS.JOBS_CREATE, PERMISSIONS.JOBS_EDIT_ALL, PERMISSIONS.JOBS_ASSIGN,
    PERMISSIONS.BIDS_VIEW_ALL, PERMISSIONS.BIDS_CREATE, PERMISSIONS.BIDS_EDIT_ALL, PERMISSIONS.BIDS_SEND,
    ...
    PERMISSIONS.SCHEDULING_VIEW, PERMISSIONS.SCHEDULING_MANAGE,
    ...
    PERMISSIONS.TIMECLOCK_OWN, PERMISSIONS.TIMECLOCK_VIEW_ALL, PERMISSIONS.TIMECLOCK_EDIT,
  ...
  inspector: [
    PERMISSIONS.JOBS_VIEW_OWN,
    PERMISSIONS.PROPERTIES_VIEW,
    PERMISSIONS.FORMS_VIEW, PERMISSIONS.FORMS_MANAGE,
    PERMISSIONS.TIMECLOCK_OWN,
  ],
};
// Backward-compatible aliases
ROLE_PERMISSIONS.office = ROLE_PERMISSIONS.office_manager;
ROLE_PERMISSIONS.tech = ROLE_PERMISSIONS.technician;
