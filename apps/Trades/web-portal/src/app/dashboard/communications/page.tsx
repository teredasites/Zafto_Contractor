...
const mockCommunications: Communication[] = [
  {
    ...
    body: 'Hi Sarah, Thank you for choosing us for your electrical panel upgrade. Please find attached your estimate for the work discussed. The total comes to $8,500 which includes all materials and labor...',
    jobId: 'j1',
    jobName: 'Panel Upgrade',
    status: 'read',
    timestamp: new Date(Date.now() - 2 * 60 * 60 * 1000),
    attachments: ['Estimate_Martinez_2024.pdf'],
  },
  {
    id: '2',
    type: 'sms',
    ...
    body: 'Hi Sarah, this is John from ABC Electric. Just confirming our appointment for tomorrow at 9am. Please reply YES to confirm.',
    status: 'delivered',
  ...
  },
  {
    ...
    customerName: 'Sarah Martinez',
    customerPhone: '(555) 234-5678',
    body: 'YES confirmed! See you tomorrow.',
    status: 'received',
  ...
  },
  {
    ...
    body: 'Customer called about quote status. Explained timeline and next steps. Customer satisfied.',
    jobId: 'j2',
    jobName: 'Commercial Wiring',
    status: 'received',
  ...
  },
  {
    ...
    subject: 'Re: Kitchen Remodel Estimate',
    body: 'Thank you for the estimate. I have a few questions about the timeline. When would you be able to start? Also, do you handle the permit process or do I need to arrange that?',
    jobId: 'j3',
  ...
  },
  {
    ...
    body: 'Hi Robert, Please find attached your invoice for the completed work. Payment is due within 30 days. You can pay online using the link below or by check.',
    status: 'sent',
    timestamp: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000),
    attachments: ['Invoice_2024_089.pdf'],
  },
];
