        ...
        <div className="space-y-6 text-sm text-main leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 text-muted">
              ...
              <li>Accessible PDF documents with tagged structure</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              Zafto is designed to be compatible with the following assistive technologies:
            </p>
            <ul className="list-disc pl-5 space-y-2 text-muted mt-2">
          ...
          <section>
            ...
            <p>
              We welcome your feedback on the accessibility of Zafto. If you experience any
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3">Continuous Improvement</h2>
            <p>
              We conduct regular accessibility audits using automated testing tools (axe-core,
              Lighthouse) and manual testing with assistive technologies. Every new feature
              undergoes accessibility verification before release as part of our development
              process.
            </p>
          </section>
        </div>
