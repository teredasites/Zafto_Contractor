...
| **Sub-step** | **SEC-AUDIT-1→6(NEXT, ~28h) → INFRA-1→5 → TEST-INFRA (TI-3/TI-5/TI-7) → COLLAB-ARCH → DEPTH2-39.** Execution order: **SEC-AUDIT-1→6(NEXT)** → INFRA-1→5 → TEST-INFRA → COLLAB-ARCH → DEPTH2-39 → DEPTH40-nonAI → DEPTH41-43 → **INTEG2-4 + INTEG6-8 (~248h)** → RE1-20 → INTEG1 → FLIP1-4 → **INTEG5** → SEC2-5 → LAUNCH2-6 → LAUNCH8 → G → JUR → E → FLIP5+DEPTH40-AI+DEPTH44 → SEC9-10 → ZERO1-9 → LAUNCH7 → **[PITR ON]** → SHIP. |
