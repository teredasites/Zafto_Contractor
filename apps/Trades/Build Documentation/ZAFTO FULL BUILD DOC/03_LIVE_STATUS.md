...
| `07_SPRINT_SPECS.md` | COMPLETE — 17,400+ lines, ~200+ sprints, Phases A through L + E5 fully detailed. Integration bridges added S103. JUR4 added S129. INTEG2-8 added S132 (~300h). S135: 16 entity gap sprints + 4 DATA-ARCH sprints added (~260h). **S138: SEC-AUDIT-1→6 + P-FIX1 + A11Y-1→3 + LEGAL-1→4 + LAUNCH-FLAVORS + APP-DEPTH added. INFRA expanded (8h→20h). LAUNCH8 expanded (12h→20h). ZERO1 expanded (8h→12h). TI-7 added (+8h). 3 hard rules: depth verification gate, i18n flawlessness, app parity. ~155 sprints, ~2,860h listed.** |
