...
**Next Action:** SEC1+SEC6-8 → LAUNCH1 → **LAUNCH9 (ops portal fortress)** → FIELD1-5 → REST → NICHE → DEPTH1-39 → **DEPTH40 non-AI** → DEPTH41-43 → RE1-20 → INTEG1 → FLIP1-4 → SEC2-5 → LAUNCH2-6 → **LAUNCH8 (deployment runbook)** → Phase G → Phase JUR (incl JUR4) → Phase E → **FLIP5 + DEPTH40-AI + DEPTH44** → SEC9-10 → ZERO1-9 → LAUNCH7 → SHIP.
